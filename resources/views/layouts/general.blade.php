    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i><span> Atención</span> <i
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('LaboratorioHDR') }}"><i class="fa fa-circle-o"></i>Gestionar hojas de ruta</a>
                        </li>
                        <li><a href="{{ url('LaboratorioHC') }}"><i class="fa fa-circle-o"></i>Registrar resultados</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="glyphicon glyphicon-book"></i><span>Asesoría / Consultoría</span> <i
                                class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{ url('consultoria') }}"><i class="fa fa-circle-o"></i>Gestionar hojas de ruta</a>
                        </li>
                        <li><a href="{{ url('consultoriaHC') }}"><i class="fa fa-circle-o"></i>Registrar resultados</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="glyphicon glyphicon-registration-mark"></i><span>Radiología</span> <i
                                class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{ url('radiologia') }}"><i class="fa fa-circle-o"></i>Gestionar hojas de ruta</a>
                        </li>
                        <li><a href="{{ url('radiologiHC') }}"><i class="fa fa-circle-o"></i>Registrar resultados</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('personal/convocatoria') }}"><i class="fa fa-circle-o"></i> Convocatoria</a>
                        </li>
                        <li><a href="{{ url('personal/seleccion') }}"><i class="fa fa-circle-o"></i> Selección</a></li>
                        <li><a href="{{ url('personal/contratacion') }}"><i class="fa fa-circle-o"></i> Contratación</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ url('personal/seleccionados') }}"><i class="fa fa-circle-o"></i>
                                Seleccionados</a></li>
                    </ul>
                </li>
                ...
                <li class="header">INDICADORES DE GESTIÓN</li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-book"></i></i>
                        <span>Procesos priorizados</span><i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li>
                        ...
                        <li>
                            <a href="{{ url('indicadores/atencion-cliente') }}"><i class="glyphicon glyphicon-info-sign"></i>
                        ...
                        <li>
                            <a href="{{ url('/') }}"><i class="glyphicon glyphicon-info-sign"></i>
                                <span>Planeamiento estratégico</span>
                            </a>
                        </li>
                    </ul>
                </li>
