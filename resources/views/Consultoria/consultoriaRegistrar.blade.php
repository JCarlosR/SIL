                ...
                <form action="">
                    <div class="tabbable"> <!-- Only required for left/right tabs -->
                      <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab2" data-toggle="tab">Tema 2</a></li>
                            <li><a href="#tab3" data-toggle="tab">Tema 3</a></li>
                            <li><a href="#tab4" data-toggle="tab">Tema 4</a></li>
                      </ul>
                      <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <button class="btn btn-success" align="center">Guardar Resultado</button>
                            </div>
