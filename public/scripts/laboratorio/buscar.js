$('#buscar').keyup(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/laboratorio/php/consulta1.php",
                    data: dataString,
    ...
    if (nombre=="") {
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/laboratorio/php/consulta2.php",
                    data: dataString,
                    success: function(data) {
                        $('#analisis').fadeIn(1000).html(data);
                    }
            });
    }
...
function actualizarRegistro(objs) {
     ...
     if (seleccionador.checked==true){ 
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/laboratorio/php/consulta3.php",
                    data: dataString,
                    success: function(data) {
                        $('#analisis').fadeIn(1000).html(data);
                    }
