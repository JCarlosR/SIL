<?php
	...
	if ($nombre<>null) {
		$query="select R.historialClinico_id, P.nombre 
				...
				on H.orden_id=O.id
				inner join resultadoslaboratorio R
	    ...
	    {
	    	$query1="select id from resultadoslaboratorio where historialClinico_id=".$cre[0]." and Resultado='' and estado='realizado'";
			...
			echo "			<tr>
	                            ...
	                            <td>
	                                <div>
	                                    &nbsp;&nbsp;<input id='".$cre[0]."' type='checkbox' onClick='validacion(this.id);cargarExamenes(this.id)'>
	                                </div>
	                            </td>
	                        </tr>";
	    }
