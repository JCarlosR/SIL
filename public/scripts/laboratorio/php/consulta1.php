<?php
	...
	if ($nombre<>null) {
	    ...
	    {	
			$query1="select COUNT(*) from resultadoslaboratorio where hojaruta_id=".$cre[0]." and estado='pendiente'";
			...
			echo "			<tr>
	                            ...
	                            <td>
	                                <div>
	                                    &nbsp;&nbsp;<input id='".$cre[0]."' type='checkbox' onClick='validacion(this.id);cargarAnalisis(this.id)'>
	                                </div>
	                            </td>
	                        </tr>";
	    }
