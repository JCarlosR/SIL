<?php
	...
	$id 	= $_REQUEST['id'];
	if ($id<>null or $id<>"no") {
		$query="select id,tipoAnalisis,historialClinico_id from resultadoslaboratorio where historialClinico_id=".$id." and Resultado='' and estado='realizado'";
		$query1="select COUNT(*) from resultadoslaboratorio where historialClinico_id=".$id." and Resultado='' and estado='realizado'";
