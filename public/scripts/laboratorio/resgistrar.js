$('#buscar').keyup(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/laboratorio/php/consultaHC1.php",
                    data: dataString,
    ...
    if (nombre=="") {
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/laboratorio/php/consultaHC2.php",
                    data: dataString,
                    success: function(data) {
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/laboratorio/php/busquedad1.php",
                    data: dataString,
                    success: function(data) {
...
function registrarResultado(objs,res) {
     ...
     var ID2 = mensaje.substring(posicion+1);
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/laboratorio/php/consultaHC3.php",
                    data: dataString,
                    success: function(data) {
                        $('#result').fadeIn(1000).html(data);
                    }
