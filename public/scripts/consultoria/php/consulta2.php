<?php
	...
	$id 	= $_REQUEST['id'];
	if ($id<>null or $id<>"no") {
		$query="select id,temaConsultoria,descripcion,hojaruta_id from resultadoconsutoria where hojaruta_id=".$id." and estado='pendiente'";
		$query1="select COUNT(*) from resultadoconsutoria where hojaruta_id=".$id." and estado='pendiente'";
    	    ...
    	    {	
    	    	if ($j==1) {
    	    		echo "<div class='tab-pane active' id='tab1'>
                            <label for='comment'>Tema a Asesorar:</label>
