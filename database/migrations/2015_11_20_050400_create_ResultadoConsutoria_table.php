...
class CreateResultadoConsutoriaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ResultadoConsutoria', function (Blueprint $table) {
            $table->increments('id');

            $table->string('temaConsultoria');
    ...
    {
        Schema::drop('ResultadoConsutoria');
    }
}
